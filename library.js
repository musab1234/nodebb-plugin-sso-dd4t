...
(function(module) {
    ...
    */
    ...
    const constants = Object.freeze({
        ...
        name: 'dd4t', // Something unique to your OAuth provider in lowercase, like "github", or "nodebb"
        oauth: {
            requestTokenURL: '',
            accessTokenURL: '',
        ...
        oauth2: {
            authorizationURL: 'https://dd4t.dadesktop.com/da/oauth2/authorize',
            tokenURL: 'https://dd4t.dadesktop.com/da/oauth2/token',
            clientID: nconf.get('oauth:id'), // don't change this line
            clientSecret: nconf.get('oauth:secret'), // don't change this line
        },
        userRoute: 'https://dd4t.dadesktop.com/da/oauth2/me', // This is the address to your app's "user profile" API endpoint (expects JSON)
    });
    ...
    OAuth.parseUserReturn = function(data, callback) {
        ...
        profile.isAdmin = data.admin ? true : false;
